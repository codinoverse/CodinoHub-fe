    ...
    if (show) {
      const fetchUsers = async () => {
        ...
        try {
          ...
          let errorMessage = 'Failed to fetch product team users';
          if (err.response) {
  ...
  return (
    <Modal show={show} onHide={handleClose} size="lg">
      <Modal.Header closeButton>
        <Modal.Title>Product Team Details</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <div className="team-modal-content">
          <div className="team-stats">
            <div className="stat-card">
              <h5>Total Product Team</h5>
              <p>{users.length}</p>
            </div>
            <div className="stat-card">
          ...
          <div className="team-table-section">
            ...
            {loading ? (
              ...
              <p>No product team members found.</p>
            ) : (
