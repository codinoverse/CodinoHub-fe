...
const SecurityModal = ({ show, handleClose }) => {
    ...
    if (show) {
      const fetchUsers = async () => {
        ...
        try {
          ...
          let errorMessage = 'Failed to fetch security team users';
          if (err.response) {
  ...
  return (
    <Modal show={show} onHide={handleClose} size="lg">
      <Modal.Header closeButton>
        <Modal.Title>Security Team Details</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <div className="team-modal-content">
          <div className="team-stats">
            <div className="stat-card">
              <h5>Total Security Engineers</h5>
              <p>{users.length}</p>
            </div>
            <div className="stat-card">
